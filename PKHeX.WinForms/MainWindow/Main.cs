...
namespace PKHeX.WinForms
{
    public partial class Main : Form
    {
        ...
        public void OpenQuick(string path) // change to public
        {
            if (!CanFocus)
            {
        ...
        // Open the pokewalker
        private void BtnPokeWalker_Click(object sender, EventArgs e) {
        }

        private void Dragout_Click(object sender, EventArgs e) {
